...
public abstract class Type 
{
    ...
    public static class ProcedureType extends Type {
        ...
        List<SymEntry.ParamEntry> formalResultParams;
        public ProcedureType(Location loc) {
            ...
            this.formalParams = new LinkedList<SymEntry.ParamEntry>();
            this.formalResultParams = new LinkedList<SymEntry.ParamEntry>();
        }
        ...
        public ProcedureType resolveType() {
            if (! resolved) {
                for(SymEntry param : formalParams) {
                    param.setType(param.type.resolveType());
                }
            }
            resolved = true;
            return this;
        ...
        /** @requires resolved */
        public List<SymEntry.ParamEntry> getFormalResultParams() {
            return formalResultParams;
        }
        public void setFormalResultParams(List<SymEntry.ParamEntry> params) {
            this.formalResultParams = params;
        }
        @Override
        public String toString() {
            String s = "PROCEDURE("; 
