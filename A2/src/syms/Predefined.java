...
public class Predefined {
    ...
    public static void addPredefinedEntries(Scope predefined) {
        // Define types needed for predefined entries
        /** Predefined integer type. */
        INTEGER_TYPE = new ScalarType("int", StackMachine.SIZE_OF_INT, 
                        Integer.MIN_VALUE, Integer.MAX_VALUE) { };
        /** Predefined boolean type. */
        List<Type.EnumerationElement> bools = 
                new ArrayList<Type.EnumerationElement>();
        bools.add(new Type.EnumerationElement("false", ErrorHandler.NO_LOCATION));
        bools.add(new Type.EnumerationElement("true", ErrorHandler.NO_LOCATION));
        BOOLEAN_TYPE = new EnumerationType(ErrorHandler.NO_LOCATION, bools, predefined);
