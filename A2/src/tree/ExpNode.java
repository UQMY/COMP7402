...
public abstract class ExpNode {
    ...
    public static class NarrowSubrangeNode extends ExpNode {
                ...
                ExpNode exp )
        {
            ...
            assert type.getBaseType() == Type.ERROR_TYPE ||
                (type instanceof Type.SubrangeType && exp.getType().equals(type.getBaseType()));
            this.exp = exp;
        }
    ...
    /** ArrayElement node representing element in the array. */
    public static class ArrayElementNode extends ExpNode {
        /** Name of the identifier */
    	private ExpNode lValue;
        private ExpNode exp;
        
        public ArrayElementNode( Location loc, ExpNode lValue, ExpNode exp ) {
            super( loc );
            this.lValue = lValue;
            this.exp = exp;
        }
		...
		@Override
        public ExpNode transform( ExpTransform<ExpNode> visitor ) {
            return visitor.visitArrayElementNode( this );
        }
        @Override
        public Code genCode( ExpTransform<Code> visitor ) {
            return visitor.visitArrayElementNode( this );
        ...
        @Override
        public String toString() {
            return "ArrayElementNode(" + lValue + "[" + exp + "])";
        }
    }
}
