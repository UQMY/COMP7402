...
public abstract class StatementNode {
    ...
    public static class ForNode extends StatementNode {
    	private ExpNode exp;
        private ExpNode cond1;
    	private ExpNode cond2;
        private ListNode loopStmt;

        public ForNode( Location loc, String id, 
        		ExpNode cond1, ExpNode cond2, 
        		ListNode loopStmt ) {
            super( loc );
            this.exp = new ExpNode.IdentifierNode(loc, id);
            this.cond1 = cond1;
            this.cond2 = cond2;
            this.loopStmt = loopStmt;
        }
		...
		@Override
        public String toString( int level ) {
            return "FOR " + exp.toString() + " : [" + cond1.toString() +
            		".." + cond2.toString() + "]" + "DO" + 
            		newLine(level+1) + loopStmt.toString( level+1 ) + "OD";
        }
    }
}
